...
router.post('/sendPhoneVerification', checkSettings(['AUTH_VERIFY_PHONE_ENABLED']), authController.sendEmailVerification);
...
router.get('/profile', checkSettings(['AUTH_PROFILE_ENABLED']), validateToken, validatePermission(['profile']), authController.profile);
